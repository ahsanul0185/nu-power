  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className="relative h-screen bg-cover bg-center flex items-center justify-center flex-col gap-5 z-0 px-6"
      >
        {/* overlay */}
        ...
        <motion.h3
          ...
          className="text-white text-base sm:text-2xl font-bold"
        >
          {" "}
          Turnkey Solar Installation Solutions for Businesses
        </motion.h3>
        <motion.h2
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.7, delay: 0.5 }}
          className="uppercase text-white font-bold text-xl sm:text-2xl text-center"
        >
          {" "}
          KZN's Most Trusted Solar Company
        </motion.h2>
      </motion.div>

      <div className="section-padding about pb-10">
        <div className="flex flex-col md:flex-row gap-8 md:-translate-y-[30%] py-16 md:py-0">
          <Card
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-5">
          ...
          >
            ...
            <p>
              <b>About Nu Power Group</b> - Nu Power Group is a trusted provider
              of <b>solar energy solutions</b> in{" "}
              <b>Western Cape and KwaZulu-Natal (KZN)</b>. We specialize in
              designing and installing <b>solar power systems</b> that help
              homes and businesses reduce electricity costs and achieve energy
              independence. Our commitment to sustainable energy ensures
              high-quality and cost-effective solar solutions for all our
              clients
            </p>

            <ul className="mt-6">
              <li>
                ✅ <b>Proven Expertise:</b> Years of experience powering KZN
                with cutting-edge solar technology.
              </li>
              <li>
                ✅ <b>Quality & Reliability:</b> Premium solar panels,
                inverters, and batteries built for durability.
              </li>
              <li>
              ...
              <li>
                ✅ <b>Customer-First Approach:</b> Dedicated support and
            ...
            <br />
            <p>
              At <b>Nu Power Group</b>, we are passionate about sustainable
              energy solutions. We stay up-to-date with industry trends through{" "}
              <a
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="flex flex-col md:w-1/2 shrink-0 gap-8 order-1 md:order-2"
          >
            <img
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-16">
          <motion.img
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="md:w-1/2 aspect-video md:aspect-auto"
            src={img_solar}
            alt="Nu Power Group"
          />
          <motion.div
